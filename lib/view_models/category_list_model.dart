...
class CategoryListModel extends ChangeNotifier {
  ...
  Future<void> _init() async {
    ...
    final defaults = <Category>[
      ...
      Category(id: 'transport',       name: 'Transport',     icon: Icons.directions_bus, colorValue: Colors.pinkAccent.toARGB32()),
      ...
      Category(id: 'other',           name: 'Other',         icon: Icons.question_mark, colorValue: Colors.grey.toARGB32()),
    ];
